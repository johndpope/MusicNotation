 ...
 */
- (instancetype)initWithX:(float)x y:(CGFloat)y width:(CGFloat)w options:(NSDictionary*)options
{
    self = [super init];
    if (self) {
        /*
...
- (void)attachPlayer:(VFPlayer*)player
{
    /*
      attachPlayer: (player) ->
        @player = player
...
- (void)setOptionsWithDictionary:(NSDictionary*)optionsDict
{
    /*
      setOptions: (options) ->
...
- (void)formatAndRenderWithContext:(CGContextRef)ctx
                          tabStaff:(VFTabStaff*)tab
                        scoreStaff:(VFStaff*)score
                         textNotes:(NSArray*)textNotes
                    customizations:(NSDictionary*)customizations
    ...
    /*
      formatAndRender = (ctx, tab, score, text_notes, customizations, options) ->
        ...
        if format_stave?
          ...
          formatter.formatToStave(format_voices, format_stave, {align_rests: align_rests}) unless
      _.isEmpty(format_voices)
...
- (void)getScoreArticulationParts
{
    /*
